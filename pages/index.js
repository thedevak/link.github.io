...
export default function Home() {
  return (
    <div className='md:container mx-auto m-7'>
      <Head>
              ...
              <div class="xl:w-1/3 md:w-1/2 p-4">
                <div class="border border-gray-200 p-6 rounded-lg">
                  <div class="w-10 h-10 inline-flex items-center justify-center rounded-full bg-green-100 text-green-500 mb-4">
                    <img src='https://s2.googleusercontent.com/s2/favicons?domain_url=https://tailblocks.cc/' />
                  </div>
                  <h2 class="text-lg text-gray-900 font-medium title-font mb-2"><a href="https://tailblocks.cc/">tailblocks.cc</a></h2>
